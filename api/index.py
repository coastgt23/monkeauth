...
class GameInfo:
    def __init__(self):
        self.TitleId : str = "15945A"
        self.SecretKey : str = "UITC45M6M1F33PTH6YBH349Z5FRPUMCUHJ1DJTW8AUECOFSN35"
        self.ApiKey : str = "OC|25706270362291667|11a651da9aa41b86c7e9990523530614"
